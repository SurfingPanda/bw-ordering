    ...
    <div class="min-h-screen bg-white text-navy-800">
        ...
        <section class="relative overflow-hidden bg-navy-900">
            ...
            <div class="relative mx-auto max-w-3xl px-4 py-16 text-center sm:px-6">
                ...
                <h1 class="mt-5 text-4xl font-bold text-white sm:text-5xl">
                    Find a <span class="font-script font-normal text-brand-400">store</span>
                </h1>
                <p class="mx-auto mt-4 max-w-md text-base text-navy-50/80">
