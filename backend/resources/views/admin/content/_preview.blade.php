{{-- Live-preview iframe for the Site Editor shell's preview pane: the real
     ...
     The content editor navigates the preview via window.swapPreview(url),
     ...
     The iframe is pointer-events:none so the preview is *look, don't touch* —
     clicking a link inside it can't navigate the preview away. Scrolling is
     handled by the outer box instead (the iframe is sized to the full page
     height and the box scrolls it). --}}
